...
public class PipeControlScreen extends AbstractContainerScreen<PipeControlMenu> {
    ...
    private static final Identifier BACKGROUND_TEXTURE = Identifier.fromNamespaceAndPath(HighLifeMod.MODID, "textures/gui/pipe_control.png");
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        guiGraphics.drawString(this.font, Component.translatable("screen.highlife.pipe_loaded", bowlState), 8, 20, 0xD7E0D7);
        guiGraphics.drawString(this.font, Component.translatable("screen.highlife.pipe_cooldown", this.menu.getCooldownPercent()), 8, 32, 0xD7E0D7);
