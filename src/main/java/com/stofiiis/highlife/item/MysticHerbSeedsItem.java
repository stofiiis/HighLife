...
public class MysticHerbSeedsItem extends BlockItem {
    public MysticHerbSeedsItem(Block block, Item.Properties properties) {
    ...
    public Component getName(ItemStack stack) {
        ...
        if (strainData.isPresent()) {
            return Component.translatable("item.highlife.mystic_herb_seeds.strained", strainData.get().strainNameComponent());
        }
    ...
    public InteractionResult place(BlockPlaceContext context) {
        ...
        if (context.getLevel() instanceof ServerLevel serverLevel
                && serverLevel.getBlockState(context.getClickedPos()).getBlock() instanceof MysticHerbCropBlock) {
