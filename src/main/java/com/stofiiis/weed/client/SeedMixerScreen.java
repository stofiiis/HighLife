...
public class SeedMixerScreen extends AbstractContainerScreen<SeedMixerMenu> {
    private static final Identifier BACKGROUND_TEXTURE = Identifier.fromNamespaceAndPath(WeedMod.MODID, "textures/gui/seed_mixer.png");
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        Component status = switch (this.menu.getMixState()) {
            case SeedMixerBlockEntity.STATE_MIXING -> Component.translatable("screen.weed.seed_mixer_mixing", this.menu.getRemainingSeconds());
            case SeedMixerBlockEntity.STATE_READY -> Component.translatable("screen.weed.seed_mixer_ready");
            default -> Component.translatable("screen.weed.seed_mixer_idle");
        };
