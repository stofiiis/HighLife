...
public class BongControlScreen extends AbstractContainerScreen<BongControlMenu> {
    private static final Identifier BACKGROUND_TEXTURE = Identifier.fromNamespaceAndPath(WeedMod.MODID, "textures/gui/bong_control.png");
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        guiGraphics.drawString(this.font, Component.translatable("screen.weed.bong_loaded", bowlState), 8, 20, 0xD4E4EB);
        guiGraphics.drawString(this.font, Component.translatable("screen.weed.bong_water", this.menu.getWaterPercent()), 8, 32, 0xD4E4EB);

        String modeText = switch (this.menu.getProcessMode()) {
            case BongControlMenu.MODE_PACKING -> Component.translatable("screen.weed.packing_bowl").getString();
            case BongControlMenu.MODE_REFILLING -> Component.translatable("screen.weed.refilling_water").getString();
            default -> Component.translatable("screen.weed.insert_bong_items").getString();
        };
