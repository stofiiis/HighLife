...
public record StrainData(Strain strain, float quality) {
    private static final String TAG_STRAIN = WeedMod.MODID + ".strain";
    private static final String TAG_QUALITY = WeedMod.MODID + ".quality";
    ...
    public Component strainNameComponent() {
        return Component.translatable("strain.weed." + this.strain.getSerializedName())
    ...
    private String qualityTranslationKey() {
        if (this.quality < 0.78F) {
            return "tooltip.weed.quality.low";
        }
        if (this.quality < 0.95F) {
            return "tooltip.weed.quality.common";
        }
        if (this.quality < 1.12F) {
            return "tooltip.weed.quality.premium";
        }
        return "tooltip.weed.quality.exotic";
    }
