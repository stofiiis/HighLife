...
import com.stofiiis.weed.effect.CottonmouthEffect;
import com.stofiiis.weed.effect.FogEffect;
import com.stofiiis.weed.effect.PeaceEffect;
import com.stofiiis.weed.effect.RelaxedEffect;
...
public final class ModEffects {
    private static final DeferredRegister<MobEffect> EFFECTS = DeferredRegister.create(Registries.MOB_EFFECT, WeedMod.MODID);
